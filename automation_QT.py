...
def eval_Value(section, key):
    '''
    Evaluates a string in the .ini file and returns the proper data type
    '2' rtype (int) 2
    '[2,3]' rtype (list) [2,3]
    '''
...
See .eval_Value() method
"""

HABITUATION_PATTERN = eval_Value("Sequence", "HABITUATION_PATTERN")


# Test solenoid pattern.
TEST_PATTERN = eval_Value("Sequence", "TEST_PATTERN")



# Start delay in seconds.
START_DELAY = eval_Value("Timing", "START_DELAY");

# Inter trial interval in seconds.
ITI = eval_Value("Timing", "ITI");

# Trial duration (valve open time) in seconds.
TRIAL_DURATION = eval_Value("Timing", "TRIAL_DURATION");

# Output file to write to
# OUTPUT_FILE = 'C:/Users/Tom Mast/Desktop/5_26_16 Dryde12en Test Test.txt'
